...
DISCLAIMER: the folder containing the optimization procedure without clothoids may be slightly different from the one used to present the results in the thesis. This is due to some changes to get something better after the document uploading phase.
